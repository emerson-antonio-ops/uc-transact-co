...
- `trace.jsonl` — optional self-reported activity trace.

If a trace is generated by the investigating agent, describe it as self-reported telemetry. Do not claim independent observation without an external collector.
